...
Para ver el número de una categoría: (n())
Para ver el número de una categoría sin valores vacíos: (sum(!is.na(x))).
Para ver el número de una categoría sin repetir: n_distinct(x)
